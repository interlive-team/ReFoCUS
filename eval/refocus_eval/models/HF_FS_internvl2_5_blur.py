...
@register_model("InternVL2_5_FRAME_SELECTION_BLUR")
class InternVL2_5_FRAME_SELECTION_BLUR(lmms):
    def __init__(
        self,
        pretrained: str,
    ...
    def _preprocessing_worker(
        ...
        for idx in order:
            ...
            frames_np = load_video_decord(self.videoloader, video_path, indices)
