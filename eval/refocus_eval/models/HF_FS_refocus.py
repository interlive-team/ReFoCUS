...
@register_model("ReFoCUS_FrameSelection")
class ReFoCUS_FrameSelection(lmms):
    def __init__(
        self,
        pretrained: str,
        *,
        ...
        vision_encode_chunk_size: int | None = None,
        **kwargs,
    ):
        super().__init__()
        ...
        if vision_encode_chunk_size is not None:
            self.model.config.vision_encode_chunk_size = int(vision_encode_chunk_size)
    ...
    def generate_until(self, requests):
        ...
        while True:
            ...
            if (
                ...
                sample_transition = logp[0][:2].half().cpu().numpy()
